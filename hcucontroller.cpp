...
void HCUController::CustomCommandCallback(CustomCommandFrame commandFrame){
    for(int i = 0; i < 16; i++){
...
void HCUController::ClimateControlCallback(ClimateControlCommandFrame commandFrame){
...
void HCUController::PrintString(char * message) {
    QString logLine = QString("Debug : %1").arg(message);
    emit logLineReceived(logLine);
}
